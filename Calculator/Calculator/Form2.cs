...
namespace Calculator
{
    public partial class Form2 : Form
    {
        ...
        public event KalkulasiEventHandler BagusKalkulasi;
        ...
        private void btnProses_Click(object sender, EventArgs e)
        {
            ...
            {
                BagusKalkulasi(0, NilaiA, NilaiB);
            }
            else if (cbOperasi.SelectedIndex == 1)
            {
                BagusKalkulasi(1, NilaiA, NilaiB);
            }
             else if (cbOperasi.SelectedIndex == 2)
            {
                BagusKalkulasi(2, NilaiA, NilaiB);
            }
             else 
            {
                BagusKalkulasi(3, NilaiA, NilaiB);
            }
        }
    }
}
